...
require_once DOKU_PLUGIN.'odt/odtstyles.inc.php';
...
class renderer_plugin_odt extends Doku_Renderer {
    ...
    /* Constructor: set the styles */
    function renderer_plugin_odt() {
        $this->autostyles = $odt_styles_autostyles;
        $this->styles = $odt_styles_styles;
        $this->fonts = $odt_styles_fonts;
    }
